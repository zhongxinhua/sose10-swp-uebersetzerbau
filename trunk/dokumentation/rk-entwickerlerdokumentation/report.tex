		...
		\subsection[XML-Lexer]{\hypertarget{XML-Lexer-API}{XML-Lexer}}
			...
			\subsubsection*{Interface}
				\begin{wrapfigure}{R}{0.3\textwidth}
					\vspace{-22pt}
					\caption{Mögliche Rückgabewerte des Statement-Lexers nach Zustand}
					\fbox{\centering
				...
				So können unter anderem \texttt{NT\_ATTR} nur auf \texttt{NT\_ATTR} oder \texttt{NT\_TAG} folgen.
