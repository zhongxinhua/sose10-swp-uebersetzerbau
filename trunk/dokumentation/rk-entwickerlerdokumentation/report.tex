...
\hypersetup{
	pdftitle={Software Projekt "Ubersetzerbau 2010: Entwicklerdokumentation / Abschlussbericht},
...
<module name="Test">
	...
	\section[Arbeitsverlauf]{\hypertarget{Arbeitsverlauf}{Arbeitsverlauf}}
		...
		\subsection{Symboltabelle}
			...
			das Klassen"= beziehungsweise Typsystem geben soll, habe ich erhebliche Wissenssprünge gemacht,
	...
	\section{Offene Baustellen}
		...
		Jene Verbesserungsvorschläge, die mir einfielen, hielt ich in 
		\texttt{Offene Baustellen.txt}\fnlink{https://dev.spline.de/svn/ss10-swp-uebersetzerbau/trunk/dokumentation/Offene\%20Baustellen.txt}
		beziehungsweise als \texttt{TODO}s an der Entsprechenden Stelle im
