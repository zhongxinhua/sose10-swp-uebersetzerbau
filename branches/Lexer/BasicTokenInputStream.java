...
class BasicTokenInputStream implements Closeable {
	...
	public BasicTokenInputStream() {
		this(System.in, "-", 1);
	}
	
	public BasicTokenInputStream(InputStream in, String name) {
		this(in, name, 0);
	}
	
	public BasicTokenInputStream(Reader in, String name) {
		this(in, name, 0);
	}
	
	public BasicTokenInputStream(InputStream in, String name, int currentIndex) {
		this(new InputStreamReader(in), name, currentIndex);
	}
	
	public BasicTokenInputStream(Reader in, String name, int currentIndex) {
